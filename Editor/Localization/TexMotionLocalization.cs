...
namespace TexMotion.Editor
{
    ...
    public static class TexMotionLocalization
    {
        ...
        private static readonly Dictionary<string, string> JapaneseText = new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            { "🦵 Left Leg" , "🦵左脚" },
            { "🦵 Right Leg" , "🦵右脚" },
            // Stylized Hand-Keyed Polish
            { "✨ Stylized Hand-Keyed Polish (手付け風クオリティ向上)", "✨ 手付け風クオリティ向上 (Stylized Polish)" },
            { "Preset:", "プリセット:" },
            { "⚡ Action", "⚡ アクション (キレ重視)" },
            { "🏋️ Weight", "🏋️ ウェイト (重量感重視)" },
            { "🍃 Subtle", "🍃 サブトル (微調整)" },
            { "Scope:", "対象範囲:" },
            { "In-Out Range", "In-Out 選択区間" },
            { "Entire Clip", "クリップ全編" },
            { "✨ Polish Motion (Entire Clip)", "✨ 手付け風補正を実行 (クリップ全編)" },
            { "✨ Polish Motion (Range {0}..{1})", "✨ 手付け風補正を実行 (区間 {0}..{1})" },
            { "Transforms dense AI mocap into stylized, punchy hand-keyed quality animation with full Undo/Redo", "AI推定のベタ打ちモーションを手付けアニメのようなキレと重力感のある高品質アニメーションへ変換します（Undo/Redo対応）" },
            { "⏱️ Timing & Spacing (緩急・キレ)", "⏱️ タイミング＆スペーシング (緩急・キレ)" },
            { "Snap & Ease (タメ・ツメ強調)", "Snap & Ease (タメ・ツメ強調)" },
            { "Snap Intensity:", "スナップ強度:" },
            { "Hold Threshold (deg/s):", "ホールド判定閾値 (deg/s):" },
            { "Anime Frame Stepping:", "アニメコマ打ち:" },
            { "Keyframe Decimator (カーブ削減)", "Keyframe Decimator (キーフレーム削減)" },
            { "Tolerance (deg):", "許容角度誤差 (deg):" },
            { "⚖️ Weight & Balance (重心・接地感)", "⚖️ ウェイト＆バランス (重心・接地感)" },
            { "Landing Cushion & Bounce (接地沈み込み)", "Landing Cushion (接地衝撃クッション)" },
            { "Cushion Depth (m):", "沈み込み深さ (m):" },
            { "Recovery Frames:", "復帰フレーム数:" },
            { "Contrapposto Booster (骨盤傾斜強調)", "Contrapposto Booster (骨盤傾斜強調)" },
            { "Boost Weight:", "強調係数:" },
            { "🌊 Overlapping & Drag (運動連鎖・しなり)", "🌊 運動連鎖＆ドラッグ (しなり・余韻)" },
            { "Kinematic Drag (四肢遅延しなり)", "Kinematic Drag (四肢遅延しなり)" },
            { "Drag Delay (frames):", "遅延フレーム数:" },
            { "Overshoot & Settling (停止時反動)", "Overshoot & Settling (停止時反動)" },
            { "Overshoot Amount:", "オーバーシュート量:" },
            { "Settle Frames:", "収束フレーム数:" },
            { "🎨 Pose & Silhouette (誇張・美化)", "🎨 ポーズ＆シルエット (誇張・美化)" },
            { "Pose Exaggeration (ポーズ誇張)", "Pose Exaggeration (ポーズ誇張)" },
            { "Exaggeration Scale:", "誇張スケール:" },
            { "Trajectory Arc Smoother (3D円弧整流)", "Trajectory Arc Smoother (3D円弧整流)" },
            { "Window Size:", "平滑化ウィンドウ:" },
            { "Blend Weight:", "ブレンド強度:" },

            // Timeline UI Redesign Entries
            { "Pose", "ポーズ" },
            { "Repair", "修復" },
            { "Timing", "タイミング" },
            { "Polish", "ポリッシュ" },
            ...
            // Pose Panel
            { "Load a motion to inspect its pose.", "モーションを読み込むとポーズを編集できます。" },
            { "Target: {0}", "対象: {0}" },
            { "Target: Root Position", "対象: ルート位置" },
            { "Modified", "変更あり" },
            { "Original", "元データ" },
            { "Frame {0} / {1}  (Frame {2} of {3})", "フレーム {0} / {1} （全 {3} フレーム中 {2}）" },
            { "Joint", "関節" },
            { "Actions", "アクション" },
            { "Palette", "パレット" },
            { "Hand & Face", "手・表情" },
            { "IK Pins", "IKピン" },
            { "Joint Selector", "関節セレクター" },
            { "All", "すべて" },
            { "Spine & Head", "体幹・頭部" },
            { "Arms", "腕部" },
            { "Legs", "脚部" },
            ...
            { "Target", "対象" },
            { "Root", "ルート" },
            { "No matching joints", "一致する関節がありません" },
            { "Root Position (metres)", "ルート位置 (メートル)" },
            { "Root Position (m)", "ルート位置 (m)" },
            { "Snap Ground (Y=0)", "地面に接地 (Y=0)" },
            { "Zero Position", "位置を原点に" },
            { "Reset to Original", "初期状態に戻す" },
            { "Joint Rotation (Euler Degrees)", "関節回転 (オイラー角・度)" },
            { "Zero Rotation", "回転をリセット" },
            { "Pose Actions", "ポーズアクション" },
            { "Body Mask", "部位マスク" },
            { "Body Mask:", "部位マスク:" },
            { "Copy Pose", "ポーズをコピー" },
            { "Paste Pose", "ポーズを貼り付け" },
            { "Mirror Pose", "ポーズを反転" },
            { "Smooth Frame", "フレームをスムーズ" },
            { "Reset Frame", "フレームをリセット" },
            { "T-Pose", "Tポーズ" },
            { "Paste clipboard pose with selected body mask", "クリップボードのポーズを指定マスクで貼り付け" },
            { "Smooth current frame with adjacent frames", "隣接フレームと補間して滑らかにします" },
            { "Pose Palette (8 Slots)", "ポーズパレット (8スロット)" },
            { "Slot {0}", "スロット {0}" },
            { "Empty", "未保存" },
            { "Capture Current Pose", "現在のポーズを保存" },
            { "Blend Weight", "ブレンド強度" },
            { "Apply to Current Frame", "現在のフレームに適用" },
            { "Apply to Range", "In-Out範囲に適用" },
            { "Clear Slot", "スロットをクリア" },
            { "Hand Gestures", "手・指ジェスチャー" },
            { "Target Hand:", "対象の手:" },
            { "Both Hands", "両手" },
            { "Left Hand", "左手" },
            { "Right Hand", "右手" },
            { "Apply Hand Preset", "ハンドプリセットを適用" },
            { "Facial Expressions", "表情アシスト" },
            { "Apply Face Preset", "表情プリセットを適用" },
            { "Emotion Intensity:", "表情の強さ:" },
            { "Emotion Intensity", "表情の強さ" },
            { "Relaxed", "脱力（自然）" },
            { "Fist", "グー（握り）" },
            { "Open", "パー（開き）" },
            ...
            { "Angry", "怒り" },
            { "Smug", "ドヤ顔" },
            { "IK Pins Solver", "IKピンソルバー" },
            { "Enable IK Pins Solving", "IKピンソルバーを有効化" },
            { "Target Limb", "対象四肢" },
            { "Reset Limb", "四肢をリセット" },
            { "Reset All Limbs to Original", "全四肢を初期状態に戻す" },

            // Repair Panel
            { "Load a motion to inspect repair tools.", "モーションを読み込むと修復ツールを使用できます。" },
            { "Repair Tools", "モーション修復ツール" },
            { "Tracking Ambiguity", "トラッキング曖昧性（交差・前後）" },
            { "Motion Glitches", "モーショングリッチ修正" },
            { "Foot Grounding & Contact", "足の接地と位置固定" },
            { "Penetration Limiter", "腕・胴体貫通リミッター" },
            { "Additive Offset", "加算オフセット" },
            { "Pose tracking confident on this frame.", "このフレームの姿勢トラッキングは安定しています。" },
            { "Swap Leg Crossing", "脚の交差順序を反転" },
            { "L-Arm Behind Head", "左腕を頭の後ろへ" },
            { "R-Arm Behind Head", "右腕を頭の後ろへ" },
            { "L-Arm Front Chest", "左腕を胸の前へ" },
            { "R-Arm Front Chest", "右腕を胸の前へ" },
            { "Scan Motion Glitches", "グリッチをスキャン" },
            { "Angular Speed Threshold", "角速度閾値" },
            { "Threshold (deg/s):", "閾値 (deg/s):" },
            { "Default", "初期値" },
            { "Sensitive", "高感度" },
            { "Loose", "低感度" },
            { "No motion glitches detected.", "グリッチは検出されませんでした。" },
            { "Fix All Glitches", "全グリッチを一括修正" },
            { "Fix Selected Glitch", "選択グリッチを修正" },
            { "Go", "移動" },
            { "Fix", "修正" },
            { "Ground Plane (Y):", "接地平面 (Y):" },
            { "Ground Plane (Y)", "接地平面 (Y)" },
            { "Ankle Offset:", "足首オフセット:" },
            { "Ankle Offset", "足首オフセット" },
            { "Lock Left Foot", "左足を固定" },
            { "Lock Right Foot", "右足を固定" },
            { "Apply Foot Grounding (Current Frame)", "現在のフレームを接地" },
            { "Apply Foot Grounding (Range In-Out)", "In-Out範囲を接地" },
            { "Apply Foot Lock (Range In-Out)", "In-Out範囲の足を固定" },
            { "Min Armpit Angle:", "最小脇角度:" },
            { "Min Armpit Angle", "最小脇角度" },
            { "Apply Penetration Limiter", "貫通リミッターを適用" },
            { "Root Height Offset (Y):", "ルート高さオフセット (Y):" },
            { "Root Height Offset (Y)", "ルート高さオフセット (Y)" },
            { "Arm Open Angle (Z):", "腕の開き角度 (Z):" },
            { "Arm Open Angle (Z)", "腕の開き角度 (Z)" },
            { "Fade Edges (Smooth Transition)", "境界をフェード（スムーズ遷移）" },
            { "Reset Offset", "オフセットをリセット" },
            { "Apply Offset to Range", "範囲にオフセットを適用" },
            { "Scope: Range [{0} .. {1}] ({2} frames)", "適用範囲: [{0} .. {1}] ({2}フレーム)" },

            // Timing Panel
            { "Load a motion to inspect timing tools.", "モーションを読み込むとタイミングツールを使用できます。" },
            { "Timing & Temporal Tools", "タイミング＆時間編集ツール" },
            { "Range Tweening", "範囲キーフレーム補間 (Tween)" },
            { "Loop Blending", "ループ境界ブレンド" },
            { "Range Retiming", "範囲リタイミング (速度・コマ数)" },
            { "Interpolation Type:", "補間カーブ:" },
            { "Interpolation Type", "補間カーブ" },
            { "Include Root Position", "ルート位置を含める" },
            { "Apply Tween", "Tween補間を適用" },
            { "Transition Frames:", "遷移フレーム長:" },
            { "Transition Frames", "遷移フレーム長" },
            { "Match Root Position", "ルート位置を一致させる" },
            { "Apply Loop Blend", "ループブレンドを適用" },
            { "New Frame Count:", "変更後のフレーム数:" },
            { "New Frame Count", "変更後のフレーム数" },
            { "Duration Preview", "再生時間プレビュー" },
            { "Original:", "変更前:" },
            { "New:", "変更後:" },
            { "Ratio:", "比率:" },
            { "Apply Retime", "リタイムを適用" },
            { "Linear", "リニア（等速）" },
            { "SmoothStep", "スムーズステップ" },
            { "EaseIn", "イーズイン（徐々に加速）" },
            { "EaseOut", "イーズアウト（徐々に減速）" },
            { "Hermite", "エルミート補間" },

            // Polish Panel
            { "Load a motion clip to apply stylized polish.", "モーションを読み込むと手付け風ポリッシュを適用できます。" },
            { "Stylized Motion Polish", "手付け風モーションポリッシュ" },
            { "Keyframe-level physics, weight, and timing enhancements.", "キーフレーム単位の物理・重量感・タイミング補正と演出" },
            { "Preset", "プリセット" },
            { "Action", "アクション (俊敏)" },
            { "Weight", "ウェイト (重量感)" },
            { "Subtle", "サブトル (微調整)" },
            ...
            { "None (Neutral)", "なし (ニュートラル)" },
            { "Customize Filters", "詳細フィルター設定" },
            { "Timing & Spacing", "タイミング＆コマ打ち" },
            { "Weight & Balance", "重量感＆バランス" },
            { "Overlap & Drag", "しなり＆追従 (Overlap)" },
            { "Pose & Silhouette", "ポーズ誇張＆軌跡美化" },
            { "Snap & Ease", "スナップ＆イーズ (緩急強調)" },
            { "Anime Frame Stepping", "アニメコマ打ち (2コマ/3コマ打ち風)" },
            { "Keyframe Decimator", "キーフレーム間引き" },
            { "Landing Cushion", "着地クッション (衝撃吸収)" },
            { "Contrapposto", "コントラポスト (骨盤・体幹傾斜)" },
            { "Kinematic Drag", "キネマティックドラッグ (四肢の遅延しなり)" },
            { "Overshoot & Settling", "オーバーシュート (反動と揺り戻し)" },
            { "Pose Exaggeration", "ポーズ誇張 (キーポーズ強調)" },
            { "Trajectory Arc Smoother", "軌跡アークスムーサー (滑らかな弧)" },
            { "Apply Polish", "ポリッシュを適用" },
            { "Affects frames [{0} .. {1}] | Mask: {2}", "対象フレーム [{0} .. {1}] | マスク: {2}" },
            ...
            // Inspector Headers, Tabs & Controls
            { "Tool", "ツール" },
            { "Frame {0} / {1}   |   Range [{2} .. {3}]", "フレーム {0} / {1}   |   範囲 [{2} .. {3}]" },
            { "Affects frames [{0} .. {1}]", "対象フレーム: [{0} .. {1}]" },
            { "Affects frames [{0} .. {1}] ({2} frames) / {3}", "対象フレーム: [{0} .. {1}] ({2}フレーム) / {3}" },
            { "Affects frames [{0} .. {1}] / Feet", "対象フレーム: [{0} .. {1}] / 両足" },
            { "Affects frames [{0} .. {1}] / Upper Arms", "対象フレーム: [{0} .. {1}] / 上腕" },
            { "Affects frames [{0} .. {1}] / Root & Arms", "対象フレーム: [{0} .. {1}] / ルート・腕" },
            { "Affects {0} detected glitch frame(s)", "対象: 検出されたグリッチ {0}フレーム" },
            { "Affects all clip frames", "対象: クリップ全フレーム" },
            { "Affects trailing {0} frames (Entire clip boundary margin) / {1}", "対象: 末尾 {0}フレーム (ループ境界マージン) / {1}" },
            { "Resamples frames [{0} .. {1}] ({2} -> {3} frames)", "リサンプリング: [{0} .. {1}] ({2} -> {3}フレーム)" },

            // Repair Panel
            { "Ambiguity Detected on Current Frame", "現在のフレームに曖昧性を検出" },
            { "Reason: {0}\nFrames: {1} - {2} (Confidence: {3})", "原因: {0}\nフレーム: {1} - {2} (信頼度: {3})" },
            { "Pose Tracking Confident", "姿勢トラッキング良好" },
            { "Tracking is confident on this frame. Use the tools below to resolve occluded limbs or crossed legs.", "このフレームのトラッキングは安定しています。手足の遮蔽や交差の乱れがある場合は以下のツールで解決できます。" },
            { "Leg Crossing Order", "脚の交差順序" },
            { "Swap Leg Crossing (Frames {0}-{1})", "脚の交差を反転 (フレーム {0}-{1})" },
            { "Swap Leg Crossing (Range {0}-{1})", "脚の交差を反転 (範囲 {0}-{1})" },
            { "Arm Posture Resolution", "腕の姿勢解決" },
            { "Target Window: Frames {0} .. {1} (Current ±3)", "対象ウィンドウ: フレーム {0} .. {1} (現在±3)" },
            { "Left Arm Behind Head", "左腕を頭の後ろへ" },
            { "Right Arm Behind Head", "右腕を頭の後ろへ" },
            { "Left Arm Front Chest", "左腕を胸の前へ" },
            { "Right Arm Front Chest", "右腕を胸の前へ" },
            { "Scan Complete", "スキャン完了" },
            { "No motion glitches or unnatural angular spikes detected in this clip.", "このクリップからモーショングリッチや不自然な角速度スパイクは検出されませんでした。" },
            { "Detected Glitches ({0} frames)", "検出されたグリッチ ({0}フレーム)" },
            { "Frame {0}: {1} ({2:F0} deg/s)", "フレーム {0}: {1} ({2:F0} deg/s)" },
            { "Ground Plane Y (m)", "接地高さ Y (m)" },
            { "Ankle Offset (m)", "足首オフセット (m)" },
            { "Foot Position Lock", "足の位置固定" },
            { "Lock Feet Position (Range)", "両足の位置を固定 (範囲)" },
            { "Snap Current Frame to Ground Y", "現在のフレームを接地Yにスナップ" },
            { "Armpit Penetration Limiter", "脇の貫通リミッター" },
            { "Torso Clearance", "胴体とのクリアランス" },
            { "Clamps minimum arm opening angle to prevent shoulders and upper arms from penetrating the chest.", "肩や上腕が胸部にめり込むのを防ぐため、脇の最小開き角度を制限します。" },
            { "Min Armpit Angle (deg)", "最小脇角度 (度)" },
            { "15 deg (Subtle)", "15度 (控えめ)" },
            { "20 deg (Standard)", "20度 (標準)" },
            { "30 deg (Wide)", "30度 (広め)" },
            { "Additive Range Offset", "範囲加算オフセット" },
            { "Hips Y Offset (m)", "腰の高さオフセット Y (m)" },
            { "Arm Open Angle (deg)", "腕の開き角度 (度)" },
            { "Fade at Range Edges", "範囲の境界をフェード" },
            { "Reset Offsets", "オフセットをリセット" },
            { "Applies relative additive elevations and arm flares smoothly across the selected range.", "選択した範囲全体に、高さや腕の開きなどの相対的な加算オフセットを滑らかに適用します。" },
            { "Affects frames [{0} .. {1}] (Detected Ambiguity: {2})", "対象フレーム: [{0} .. {1}] (検出された曖昧性: {2})" },
            { "Apply Foot Grounding (Range)", "足の接地を適用 (範囲)" },
            { "Apply Armpit Limiter", "脇リミッターを適用" },
            { "Apply Additive Offset", "加算オフセットを適用" },
            { "Apply Repair", "修復を適用" },

            // Timing Panel
            { "Range Keyframe Tweening", "キーフレーム間Tween補間" },
            { "Loop Boundary Blending", "ループ境界のスムーズブレンド" },
            { "Range Retiming (Time Warp)", "範囲リタイミング (タイムワープ)" },
            { "Interpolation", "補間" },
            { "Include Root Pos", "ルート位置を含める" },
            { "Range Tweening requires at least 3 frames (In-point, interior frames, Out-point). Extend the range in the timeline below.", "範囲Tween補間には少なくとも3フレーム（In点、中間フレーム、Out点）が必要です。タイムラインで範囲を広げてください。" },
            { "Interpolation Scope", "補間範囲" },
            { "Keyframe Start: Frame {0}\nKeyframe End: Frame {1}\nInterior Resampled: {2} frames", "開始キーフレーム: フレーム {0}\n終了キーフレーム: フレーム {1}\nリサンプリング中間: {2}フレーム" },
            { "Blend Root Pos", "ルート位置をブレンド" },
            { "Boundary Details", "境界ブレンド詳細" },
            { "Cross-blends frames [{0} .. {1}] into Frame 1 for continuous, seamless cyclic playback.", "フレーム [{0} .. {1}] を第1フレームへクロスブレンドし、シームレスなループ再生を実現します。" },
            { "0.5x Slow", "0.5倍 (スロー)" },
            { "1.0x Reset", "1.0倍 (等速)" },
            { "1.5x Fast", "1.5倍 (高速)" },
            { "2.0x Double", "2.0倍 (2倍速)" },
            { "Original: {0} frames ({1:F2}s)\nRetimed:  {2} frames ({3:F2}s)\nSpeed Factor: {4:F2}x\nNew Total Clip: {5} frames", "変更前: {0}フレーム ({1:F2}秒)\n変更後: {2}フレーム ({3:F2}秒)\n速度比: {4:F2}倍\nクリップ総フレーム数: {5}フレーム" },
            { "Retiming requires at least 2 frames in the selected range.", "リタイミングには選択範囲内に少なくとも2フレームが必要です。" },
            { "Apply Range Tween", "範囲Tween補間を適用" },
            { "Apply Loop Boundary Blend", "ループ境界ブレンドを適用" },
            { "Apply Retime Range", "範囲リタイミングを適用" },
            { "Apply Timing Action", "タイミング処理を適用" },
            { "Body Parts", "対象部位" },
            { "Upper", "上半身" },
            { "Lower", "下半身" },
            ...
            // Polish Panel
            { "Active Filters", "有効なフィルター" },
            { "{0} of 9 enabled", "9個中 {0}個 有効" },
            { "No filters enabled", "有効なフィルターはありません" },
            { "Snap Intensity", "スナップ強度" },
            { "Hold Threshold (deg/s)", "静止判定閾値 (deg/s)" },
            { "Step Mode", "ステップモード" },
            { "Tolerance (deg)", "許容角度 (度)" },
            { "Landing Cushion & Bounce", "着地クッション＆バウンス" },
            { "Cushion Depth (m)", "沈み込み深さ (m)" },
            { "Recovery Frames", "復元フレーム数" },
            { "Contrapposto Booster", "コントラポスト強調" },
            { "Boost Weight", "強調強度" },
            { "Drag Delay (frames)", "遅延フレーム数" },
            { "Overshoot Amount", "オーバーシュート量" },
            { "Settle Frames", "収束フレーム数" },
            ...
            { "Frame Stepping", "コマ打ち" },
            { "Decimator", "間引き" },
            { "Arc Smoother", "軌跡スムーサー" },

            // Additional Pose Panel Keys
            { "Hand Pose", "手・指ポーズ" },
            { "Root Position", "ルート位置" },
            { "Face Emotion", "表情" },
            { "None", "なし" },
            ...
            // UI Tooltips (Inspector Mode Tabs)
            { "Inspect and modify joint rotations, root position, pose actions, palette, and IK pins.", "関節回転、ルート位置、ポーズアクション、パレット、IKピンの確認と編集を行います。" },
            { "Fix tracking ambiguity, glitches, foot grounding, and penetrations.", "トラッキング曖昧性、グリッチ、足の接地、めり込みを修復します。" },
            { "Adjust timing with range tweening, seamless loop blending, and retiming.", "Tween補間、ループ境界ブレンド、リタイミングによる時間調整を行います。" },
            { "Apply keyframe-level stylized motion polish, anime stepping, and physical weight.", "手付け風の緩急強調、アニメ風コマ打ち、重量感などの演出ポリッシュを適用します。" },

            // UI Tooltips (Selection & Transport Controls)
            { "Range start frame.", "範囲選択の開始フレームです。" },
            { "Set the range start to current frame.", "現在のフレームを開始位置に設定します。" },
            { "Range end frame.", "範囲選択の終了フレームです。" },
            { "Set the range end to current frame.", "現在のフレームを終了位置に設定します。" },
            { "Select the entire motion range.", "モーションクリップ全体を選択範囲に設定します。" },
            { "Adjust timeline zoom level.", "タイムラインの表示倍率（ズーム）を調整します。" },

            // UI Tooltips (Pose Panel Sub-tools & Controls)
            { "Single-joint selection and Euler angle editing.", "単一関節の選択とオイラー角編集を行います。" },
            { "Clipboard operations, pose mirroring, smoothing, and reset.", "ポーズのコピー・反転・スムーズ・初期化操作を行います。" },
            { "Quick-save and blend up to 8 pose snapshots.", "最大8つのポーズスナップショットを保存しブレンド適用します。" },
            { "Expressive hand gesture and facial emotion presets.", "手・指のジェスチャーや表情プリセットを適用します。" },
            { "Pin hands and feet in world space while editing other joints.", "手足をワールド座標に固定しながら他の関節を編集します。" },
            { "Filter joints: All", "全関節を表示します。" },
            { "Filter joints: Spine & Head", "体幹・頭部の関節を表示します。" },
            { "Filter joints: Arms", "腕部の関節を表示します。" },
            { "Filter joints: Legs", "脚部の関節を表示します。" },
            { "Filter joints by name", "関節名で絞り込みます。" },
            { "Select root joint", "ルート（骨盤）を選択します。" },
            { "Snap root position vertically to ground level (Y=0).", "ルートの高さを地面（Y=0）に接地させます。" },
            { "Reset root position to origin (0, 0, 0).", "ルート位置を原点 (0, 0, 0) にリセットします。" },
            { "Revert root position to original motion value.", "ルート位置をオリジナルの状態に戻します。" },
            { "Reset Euler angles of this joint to (0, 0, 0).", "この関節の回転角を (0, 0, 0) にリセットします。" },
            { "Revert this joint rotation to original motion value.", "この関節の回転をオリジナルの状態に戻します。" },
            { "Copy current frame pose to clipboard.", "現在のフレームのポーズをクリップボードにコピーします。" },
            { "Paste pose from clipboard to current frame.", "クリップボードのポーズを現在のフレームに貼り付けます。" },
            { "Mirror left and right limbs across the sagittal plane.", "左右の手足を反転します。" },
            { "Reset all joints to canonical humanoid T-Pose.", "全関節をTポーズにリセットします。" },
            { "Capture current frame pose into this slot.", "現在のポーズをこのスロットに保存します。" },
            { "Apply or blend this saved pose into the current frame.", "保存したポーズを現在のフレームにブレンド適用します。" },
            { "Apply or blend this saved pose across the selected In-Out range.", "保存したポーズを選択したIn-Out範囲全体に適用します。" },
            { "Clear saved pose from this slot.", "このスロットのポーズデータを消去します。" },
            { "Apply selected hand preset to current frame.", "選択したハンドプリセットを現在のフレームに適用します。" },
            { "Apply selected facial emotion preset to current frame.", "選択した表情プリセットを現在のフレームに適用します。" },
            { "Revert this limb to original motion pose.", "この四肢をオリジナルのポーズに戻します。" },
            { "Revert all limbs to original motion pose.", "全四肢をオリジナルのポーズに戻します。" },

            // UI Tooltips (Repair Panel)
            { "Swap left and right leg crossing order for this segment.", "この区間の脚の前後交差順序を反転します。" },
            { "Place left arm behind head to resolve occluded depth.", "左腕を頭の後ろ側に配置して遮蔽の前後関係を解決します。" },
            { "Place right arm behind head to resolve occluded depth.", "右腕を頭の後ろ側に配置して遮蔽の前後関係を解決します。" },
            { "Place left arm in front of chest.", "左腕を胸の前に配置します。" },
            { "Place right arm in front of chest.", "右腕を胸の前に配置します。" },
            { "Scan clip for unnatural angular velocity spikes and motion glitches.", "不自然な角速度スパイクやモーショングリッチをクリップ全体からスキャンします。" },
            { "Jump to this glitch frame.", "このグリッチが発生しているフレームへ移動します。" },
            { "Fix this motion glitch using surrounding frame interpolation.", "周囲フレームからの補間によってこのグリッチを修正します。" },
            { "Fix all detected motion glitches across the clip.", "検出されたすべてのグリッチを一括修正します。" },
            { "Lock feet positions in place across the selected In-Out range.", "選択したIn-Out範囲全体で足の位置を固定（スリップ防止）します。" },
            { "Snap hips vertically so the lowest foot contacts the ground plane.", "最も低い足が地面に接するように現在のフレームの腰高さをスナップします。" },
            { "Apply foot grounding adjustment across the selected In-Out range.", "選択したIn-Out範囲全体に足の接地補正を適用します。" },
            { "Apply armpit penetration limiter to prevent arm-torso clipping.", "腕が胴体にめり込むのを防ぐ貫通リミッターを適用します。" },
            { "Apply additive elevation and arm opening offsets across the range.", "高さや腕の開き角度などの加算オフセットを選択範囲に滑らかに適用します。" },
            { "Reset additive offset values to zero.", "加算オフセットの値をゼロにリセットします。" },

            // UI Tooltips (Timing Panel)
            { "Interpolate interior frames between range start and end keyframes.", "範囲の開始と終了キーフレームの間を滑らかに補間します。" },
            { "Blend clip boundaries smoothly for seamless cyclic looping.", "クリップの境界を滑らかにブレンドしシームレスなループ再生を実現します。" },
            { "Time-warp or stretch the selected frame range to a new duration.", "選択したフレーム範囲の速度やコマ数をリサンプリングして伸縮します。" },
            { "Slow down range to half speed (2x frames).", "選択範囲を0.5倍速（フレーム数を2倍）にします。" },
            { "Reset retime count to match original range span.", "変更後のフレーム数を元の範囲と同じ（等速）にリセットします。" },
            { "Speed up range to 1.5x speed.", "選択範囲を1.5倍速にします。" },
            { "Double speed of range (half frames).", "選択範囲を2倍速（フレーム数を半分）にします。" },
            { "Body part mask: All", "全身体を対象にします。" },
            { "Body part mask: Upper body", "上半身のみを対象にします。" },
            { "Body part mask: Lower body", "下半身のみを対象にします。" },
            { "Body part mask: Arms", "腕部のみを対象にします。" },
            { "Body part mask: Legs", "脚部のみを対象にします。" },

            // UI Tooltips (Polish Panel)
            { "Snappy, high-contrast action anime preset.", "メリハリのあるアニメ風俊敏アクションプリセットです。" },
            { "Realistic weight, landing cushions, and natural settling.", "重厚感、着地衝撃吸収、自然な揺り戻しを重視したプリセットです。" },
            { "Subtle natural polish without changing overall timing.", "全体のタイミングを崩さず微細なしなりや美化を加えるプリセットです。" },
            { "Custom manual configuration of polish filters.", "各フィルターのパラメータを手動で詳細設定します。" },
            { "Apply selected stylized polish filters to the In-Out range.", "選択した手付け風ポリッシュフィルターをIn-Out範囲に適用します。" },
            { "Snap fast poses with sharp ease-ins and ease-outs.", "ポーズの切り替わりを鋭くスナップさせ緩急を強調します。" },
            { "Hold poses across 2 or 3 frames for a stylized anime feel.", "2コマ/3コマ打ち風にポーズをホールドしてリミテッドアニメ調にします。" },
            { "Remove redundant dense keyframes while preserving extremes.", "キーポーズの極値を維持しながら不要な密フレームを間引きます。" },
            { "Simulate downward knee and hip compression upon landing.", "着地時の膝と腰の沈み込みと反動をシミュレートします。" },
            { "Tilt hips and spine to emphasize physical weight shifting.", "骨盤と背骨のカウンターチルトで重心移動を強調します。" },
            { "Add trailing delay down kinematic limb chains.", "体幹の動きに対して四肢の先端が遅れて追従するしなりを加えます。" },
            { "Add spring-like bounce and settling to sudden stops.", "急停止時の反動と揺り戻し（オーバーシュート）を加えます。" },
            { "Scale up peak poses for stronger, dynamic silhouettes.", "キーポーズのシルエットを誇張してダイナミックに見せます。" },
            { "Smooth hand and foot paths into clean, beautiful spatial arcs.", "手足の空間軌跡を美しく滑らかな弧（アーク）に整えます。" },

            // Additional & Legacy Timeline Editor Tooltips
            { "Revert current frame to original motion data.", "現在のフレームのポーズをオリジナルの状態に戻します。" },
            { "Smooth current frame with adjacent frames.", "現在のフレームのポーズを前後のフレームと滑らかにブレンドします。" },
            { "Automatically repairs all detected glitches via neighboring frame Slerp", "周囲フレームのSlerp補間により検出されたすべてのグリッチを一括自動修正します。" },
            { "Blends active palette pose across In-Out range with selected mask", "選択した部位マスクでアクティブなパレットポーズをIn-Out範囲全体にブレンド適用します。" },
            { "Adds root elevation and arm angle across the selected frame range", "選択したフレーム範囲全体にルート高さと腕の開き角度を加算オフセットします。" },
            { "Paste clipboard pose to masked parts only", "クリップボードのポーズを選択した部位マスクのみに貼り付けます。" },
            { "Smooth masked parts with neighbor frames", "選択した部位マスクの関節を前後のフレームと滑らかにブレンドします。" },
            { "Snaps feet to ground plane across In-Out range", "選択したIn-Out範囲全体で足の高さを地面レベルに接地スナップします。" },
            { "Resamples and rescales the In-Out range frames", "選択したIn-Out範囲のフレームをリサンプリングして伸縮（タイムワープ）します。" },
            { "Blends active palette pose into current frame with selected mask", "選択した部位マスクでアクティブなパレットポーズを現在のフレームにブレンド適用します。" },
            { "Snaps feet to ground plane on current frame", "現在のフレームで足の高さを地面レベルに接地スナップします。" },
            { "Reverses anterior/posterior leg crossing order (Swaps which leg is in front)", "脚の前後交差順序を反転（どちらの足が前かを入れ替え）します。" },
            { "Scans for unnatural spikes, high angular velocity, or sudden flips", "不自然な角速度スパイクや急激な反転などのモーショングリッチをスキャンします。" },
            { "Smoothly interpolates poses from Range In to Range Out using selected easing and body mask", "選択したイージングと部位マスクを用いてIn点からOut点までのポーズを滑らかに補間します。" },
            { "Reset masked parts to original generated pose", "選択した部位マスクの関節をオリジナルの生成ポーズにリセットします。" },
            { "Clears the active slot", "アクティブなパレットスロットのデータを消去します。" },
            { "Prevents arms from penetrating chest/torso across range", "選択範囲全体で腕が胸や胴体にめり込むのを防止します。" },
            { "Cross-blends motion start and end frames for seamless looping", "モーションの始点と終点をクロスフェードしてシームレスなループを作成します。" },
            { "Locks feet positions to prevent sliding across In-Out range", "選択したIn-Out範囲全体で足の位置を固定し、すべり（フットスライド）を防止します。" },

            // Viewport HUD & Background Modes
            { "Stage", "ステージ" },
            { "Dark", "ダーク" },
            { "Green", "グリーン" },
            { "3D stage with ground grid and contact shadows.", "グリッド床と接地シャドウを備えた3Dステージ空間を表示します。" },
            { "Classic dark minimalist background.", "クラシックなミニマル黒背景を表示します。" },
            { "Pure chroma key green background for video compositing.", "映像合成・切り抜き用の純緑（クロマキー）背景を表示します。" },
            { "Toggle skeleton bone lines and joint spheres.", "骨格ラインと関節スフィアの表示を切り替えます。" },
            { "Toggle 3D rotation gizmos in Pose Mode.", "ポーズモードの3D回転ギズモ表示を切り替えます。" },
            { "Toggle onion skinning overlay for neighboring frames.", "前後フレームのオニオンスキン重ね表示を切り替えます。" },
            { "Switch viewport background mode (Stage, Dark, Green Screen).", "ビューポートの背景モード（ステージ／ダーク／グリーン）を切り替えます。" },

            // Grounding & Foot Contact
            { "Ground", "接地" },
            { "Auto-align avatar feet to ground plane (removes floating).", "アバターの足元を地面に自動接地させ、浮きを解消します。" },
            { "Grounding Actions", "接地アクション" },
            { "Ground Entire Clip", "クリップ全体を地面に接地" },
            { "Shift the entire motion clip so the lowest foot landing touches Ground Y.", "クリップ全体の最下点がGround Yに接地するようにモーション全体を垂直シフトします。" },
            { "Snap In-Out Range to Ground Y", "In-Out範囲を地面に接地" },
            { "Snap lowest feet to Ground Y across the selected In-Out range.", "選択したIn-Out範囲内で足の高さをGround Yにスナップします。" },
        };
